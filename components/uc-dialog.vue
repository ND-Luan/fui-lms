<template>
    <v-dialog v-model="modelValue" :width="width" :close-on-back="false" v-bind="$attrs">
        <v-card>
            ...
            <v-card-actions>
                ...
                <v-btn v-if="isShowDoneBtn" text color="primary" variant="elevated" prepend-icon="mdi-content-save" @click="handleSubmit">
                    {{ doneText }}
                </v-btn>
            </v-card-actions>
        </v-card>
