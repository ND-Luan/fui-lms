...
$sqlFiles = @(
    'alter_so_gvcn_theo_doi_si_so_thang.sql',
    'spAPI_SoGVCNTheoDoiSiSoThangSave.sql',
    'spAPI_SoGVCNTheoDoiSiSoThangGet.sql'
)
...
WHERE p.name IN (
    'spAPI_SoGVCNTheoDoiSiSoThangSave',
    'spAPI_SoGVCNTheoDoiSiSoThangGet'
)
