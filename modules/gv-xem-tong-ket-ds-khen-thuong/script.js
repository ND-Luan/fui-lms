...
async function exportGiayKhen() {
    ...
    // const base64_UTM_Father = await getFontBase64('/_cdn/lhbs-lms/UTM_Father.ttf');
    // const base64_UTM_Father_Bold = await getFontBase64('/_cdn/lhbs-lms/UTM_Father_Bold.ttf');
    // const base64_TUV_Noh_Carbone = await getFontBase64('/_cdn/lhbs-lms/TUV_Noh_Carbone.ttf');
    // const base64_GreatVibes_Regular = await getFontBase64('/_cdn/lhbs-lms/GreatVibes_Regular.ttf');
    // const base64_KhenTang = await getFontBase64('/_cdn/lhbs-lms/khentang.png')
    // // Gán vào vfs và font
    // pdfMake.vfs = pdfMake.vfs || {};
    // pdfMake.vfs['UTM_Father.ttf'] = base64_UTM_Father;
    // pdfMake.vfs['UTM_Father_Bold.ttf'] = base64_UTM_Father_Bold;
    // pdfMake.vfs['TUV_Noh_Carbone.ttf'] = base64_TUV_Noh_Carbone;
    // pdfMake.vfs['GreatVibes_Regular.ttf'] = base64_GreatVibes_Regular;
    // pdfMake.fonts = {
    //     GreatVibes_Regular: {
    //         normal: 'GreatVibes_Regular.ttf',
    //         bold: 'GreatVibes_Regular.ttf',
    //         italics: 'GreatVibes_Regular.ttf',
    //         bolditalics: 'GreatVibes_Regular.ttf'
    //     },
    //     TimesNewRoman: {
    //         normal: 'times.ttf',
    //         bold: 'timesbd.ttf',
    ...
    //     },
    //     TUV_Noh_Carbone: {
    //         normal: 'TUV_Noh_Carbone.ttf',
    //         bold: 'TUV_Noh_Carbone.ttf',
    //         italics: 'TUV_Noh_Carbone.ttf',
    //         bolditalics: 'TUV_Noh_Carbone.ttf'
    //     },
    //     UTM_Father: {
    //         normal: 'UTM_Father.ttf',
    //         bold: 'UTM_Father.ttf',
    //         italics: 'UTM_Father.ttf',
    //         bolditalics: 'UTM_Father.ttf'
    //     },
    //     UTM_Father_Bold: {
    //         normal: 'UTM_Father_Bold.ttf',
    //         bold: 'UTM_Father_Bold.ttf',
    //         italics: 'UTM_Father_Bold.ttf',
    //         bolditalics: 'UTM_Father_Bold.ttf'
    //     }
    // };
    // const DSDanhHieu = [
    //     {
    ...
    // }
    // for (var data of vueData.DSHocSinhQLD.filter(x => x.DanhHieu?.length > 0)) {
    //     const KHENTANG_HOCSINH = {
    //         text: "Khen tặng học sinh",
    //         font: "UTM_Father_Bold",
    //         alignment: "center",
    //         italics: true,
    //         bold: true,
    //         fontSize: 29,
    //         margin: [0, 0, 0, 8]
    //     }
    //     const KHENTANG_HOCSINH_TA = {
    //         text: "We gladly present",
    //         font: "UTM_Father_Bold",
    //         alignment: "center",
    //         italics: true,
    //         fontSize: 22,
    ...
    //     }
    //     const DanhHieu_VI = {
    //         text: "Đạt danh hiệu " + data.DanhHieu,
    //         alignment: "center",
    //         fontSize: 18,
    //         italics: true,
    //         bold: true,
    ...
    //     const objEN_DanhHieu = DSDanhHieu.find(x => x.DanhHieu_VI === data.DanhHieu)
    //     const DanhHieu_EN = {
    //         text: objEN_DanhHieu?.DanhHieu_EN,
    //         alignment: "center",
    //         fontSize: 15,
    //         margin: [0, 0, 0, 4],
    //         italics: true
    ...
    //     }
    //     const NamHoc_EN = {
    //         text: "In the school year 2024-2025",
    //         alignment: "center",
    //         margin: [0, 0, 0, 4],
    //         fontSize: 15,
    //         italics: true
    ...
    //     }
    //     const pageBreak = { text: '', fontSize: 14, bold: true, pageBreak: 'before', margin: [0, 0, 0, 8] }
    //     content.push(KHENTANG_HOCSINH)
    //     content.push(KHENTANG_HOCSINH_TA)
    //     // content.push(IMG)
    //     content.push(HOTEN)
    //     content.push(LOP)
    //     content.push(DanhHieu_VI)
    //     content.push(DanhHieu_EN)
    //     content.push(NamHoc_VI)
    //     content.push(NamHoc_EN)
    ...
    //     content: val.content,
    //     pageMargins: [20, 265, 30, 40],
    //     images: {
    //         khentang: "https://lms.lhbs.vn/_cdn/lhbs-lms/khentang_1.png"//base64_KhenTang,
    //     },
    //     styles: {
    //         title: {
    //             fontSize: 16,
