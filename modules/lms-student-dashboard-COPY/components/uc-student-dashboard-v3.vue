<template>
	<uc-navigation-drawer v-model:activeKey="activeKey" v-model:activeMonHocID="activeMonHocID"
		...
		<!-- Alert -->
		<!-- <uc-alert /> -->
		<div v-if="activeKey === 0 && NienKhoa"> <uc-nhiem-vu :NienKhoa /></div>
		<div v-if="activeKey === 1 && NienKhoa"> <uc-hoat-dong :NienKhoa /></div>
		<div v-if="activeKey === 2 && NienKhoa"> <uc-tien-do :NienKhoa /></div>
		<div v-if="activeKey === 3 && NienKhoa"><uc-ca-nhan :NienKhoa /></div>
