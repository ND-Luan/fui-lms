...
function convertDSHocSinh() {
    ...
    for (var hocSinh of sortDSHocSinh.filter(x => x.HocSinhID === 24100038)) {
        ...
        console.table(newArrCotDiemExist);

        for (var cotDiemExist of newArrCotDiemExist) {
            // console.log(hocSinh.Ho, hocSinh.Ten, cotDiemExist.MaCotDiem, cotDiemExist.Formula);
