	...
	methods: {
		...
		onLoadDSMaCotDiem(MaNhomCotDiem, TemplateBangDiemID) {
			return new Promise(resolve => {
				...
				// )
				this.DSCotDiem = [{
					"MaNhomCotDiem": "DiemGK_HK1",
					"TenNhomCotDiem_VI": "Điểm giữa kỳ HK1",
					"TenCotDiem_VI": "Tổng",
					"MaCotDiem": "DiemGK_HK1",
				},
				{
					"MaNhomCotDiem": "DiemCK_HK1",
					"TenNhomCotDiem_VI": "Điểm cuối HK1",
					"TenCotDiem_VI": "Tổng",
					"MaCotDiem": "DiemCK_HK1",
				},
				{
					"MaNhomCotDiem": "DiemGK_HK2",
					"TenNhomCotDiem_VI": "Điểm giữa kỳ HK2",
					"TenCotDiem_VI": "Tổng",
					"MaCotDiem": "DiemGK_HK2",
				},
				{
					"MaNhomCotDiem": "DiemCK_HK2",
					"TenNhomCotDiem_VI": "Điểm cuối HK2",
					"TenCotDiem_VI": "Tổng",
					"MaCotDiem": "DiemCK_HK2",
				}]
				resolve()
			})
		},
		onLoadChart({ NienKhoa, KhoiID, MonHocID, MaCotDiem }) {
			return new Promise(resolve => {
				...
				console.log('this.form.MaNhomCotDiem', this.form.MaNhomCotDiem)
				console.log('this.DSCotDiem', this.DSCotDiem)
