			...
			<v-card :flat="false">
				<v-card-title class="text-primary">
					...
					<div class="d-flex ga-2">
						...
						<v-chip color="orange" prepend-icon="mdi-human-capacity-increase">{{ item?.SoHocSinhCaoHon ?? 0
							}}</v-chip>
						<v-chip color="light-green" prepend-icon="mdi-arrow-up-circle-outline">{{ item?.TiLePhanTram ??
							0 }} %</v-chip>
					</div>
				</v-card-title>
				<v-row no-gutters>
						...
						<v-table>
							<thead>
								<tr>
									...
									<th class="text-right">
										<v-btn color="orange" icon="mdi-human-capacity-increase" variant="text"></v-btn>
										CK1 > GK1
									</th>
									<th class="text-right">
										<v-btn color="light-green" icon="mdi-arrow-up-circle-outline"
				...
				<v-col cols="12">
					<v-card :flat="false">
						...
						<v-card-text>
							<uc-chart-apex :options="Chart_DiemTrungBinh" v-if="Chart_DiemTrungBinh" />
						</v-card-text>
					</v-card>
				</v-col>
				<!-- <v-col cols="6">
