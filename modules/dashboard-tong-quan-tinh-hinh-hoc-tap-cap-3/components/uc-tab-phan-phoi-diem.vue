<template>
	<v-card class="pa-4" style="background-color: #f9f9f9;height: calc(100dvh - 124px);
    overflow: auto;">
		<v-card>
			<v-card-text>
				<v-row dense>
...
export default {
	...
	async mounted() {
		...
		if (!this.form.KhoiID || !this.form.MonHocItem.MonHocID || !MaNhomCotDiem || !MaCotDiem) return
