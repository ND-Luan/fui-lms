				...
				<keep-alive>
					<v-tabs-window v-model="tab">
						<v-tabs-window-item v-for="hocKy in DSHocKy" :key="hocKy.id" :value="hocKy.id">
							<v-card>
								...
								<v-expansion-panels v-model="GroupPanel" flat multiple>
									...
									<v-expansion-panel key="1" >
										<v-expansion-panel-title class="bg-blue-lighten-5 group-panel" expand-icon="mdi-menu-down">
										...
										<v-expansion-panel-text>
											...
											<v-row  :no-gutters="true"
												class="font-weight-medium rounded-t py-2">
												<v-col cols="7">
											...
											<v-expansion-panels>
												<v-expansion-panel v-for="(value, key) in groupKTKN" :key="value+'_'+key">
															...
															<v-col cols="7" class="pa-2">
																<v-chip class="font-weight-medium chip-ellipsis" 
																	...
																	<v-icon small class="mr-1"
																		...
																		{{DSMonHoc.find(x => x.MonHocName === key || (key == 'Giáo dục thể chất' && x.MonHocName=='Thể dục' ))?.Icon || 'mdi-book-open'}}
																	</v-icon>
																	{{ key }}
																</v-chip>
															</v-col>
									...
									<v-expansion-panel  key="2">
										<v-expansion-panel-title class="bg-red-lighten-5 group-panel" expand-icon="mdi-menu-down">
											<div class="d-flex align-center ga-4">
													...
													<v-expansion-panel-title class="px-2">
														<v-row :no-gutters="true">
															<v-col cols="9" class="pa-2">
																<v-chip class="font-weight-medium chip-ellipsis"  :color="DSMonHoc.find(x => x.MonHocName === key)?.Color ?? '#000000'">
																	<v-icon small class="mr-1"
									...
									<v-expansion-panel  key="4">
										<v-expansion-panel-title class="bg-brown-lighten-5 group-panel" expand-icon="mdi-menu-down">
											<div class="d-flex align-center ga-4">
							...
							<v-card>
								<v-row class="ma-0">
									<v-col cols="12" class="pb-0 text-primary" style="font-size: .9375rem; font-weight: 500;">
								...
								<v-expansion-panel v-for="item in dataHK_1_C2_C3.Diem" v-if="hocKy.id === 1">
									<v-expansion-panel-title expand-icon="mdi-menu-down"
										...
										<div class="d-flex justify-space-between align-center w-100">
											...
											<v-chip class="vChip-full-width-content" color="#1d581e" size="small" variant="flat"
...
export default {
	...
	watch: {
		...
		// "vueData.NienKhoa": async function (nienKhoa) {
		// 	await this.loadHocSinhKQHT(this.tab)
		// }
	},
	methods: {
		loadCongBoBangDiem() {
