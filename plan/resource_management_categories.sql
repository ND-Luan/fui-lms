...
GRANT ALTER, CONTROL, TAKE OWNERSHIP, VIEW DEFINITION ON OBJECT::[dbo].[spAPI_FP_TaiNguyenLoai_GetAll] TO [lmslhbs];
GRANT ALTER, CONTROL, TAKE OWNERSHIP, VIEW DEFINITION ON OBJECT::[dbo].[spAPI_FP_TaiNguyenMuc_GetAll] TO [lmslhbs];
...
GRANT ALTER, CONTROL, TAKE OWNERSHIP, VIEW DEFINITION ON OBJECT::[dbo].[spAPI_FP_TaiNguyen_SourceFile_GetAll] TO [lmslhbs];
