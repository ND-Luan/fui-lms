<template>
	<div class="assignment-row rounded-lg"
		...
		<div class="assignment-details">
			<div class="assignment-title d-flex flex-md-row flex-column gap-2 align-md-center align-start">
				<div>
					...
					<v-chip v-if="assignment.Chuong" size="small" label="" variant="text"
						class="pa-0 font-weight-medium" color="#d16a6a"> {{
		...
		<div class="assignment-stats d-flex flex-wrap gap-2 flex-column flex-md-row" v-else="">
			...
			<v-chip v-if="assignment.ResourceType === 'LESSON'" size="small" variant="text" color="info"
				class="font-weight-medium">
			...
			<v-chip v-if="assignment.ResourceType === 'LESSON'" size="small" variant="text" color="#4CAF50"
				class="font-weight-medium">
				{{ $t('message.Completed') }}: {{ assignment.CompletedCount }}
			</v-chip>
			<!-- Cột hành động -->
