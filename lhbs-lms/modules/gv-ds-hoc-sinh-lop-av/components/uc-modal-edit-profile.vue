		...
		<v-card>
			...
			<v-card-text>
				<v-form>
					<v-row>
						<v-col cols="6">
							<v-text-field v-model="vueData.StudentProfile.HocSinhID" label="Mã học sinh" disabled>
							</v-text-field>
						</v-col>
						<v-col cols="6">
							<v-text-field v-model="vueData.StudentProfile.HoTen" label="Họ tên học sinh" disabled>
							</v-text-field>
						</v-col>
						<v-col>
							<v-text-field v-model="vueData.StudentProfile.EnglishName" label="English Name">
							</v-text-field>
						</v-col>
					</v-row>
				</v-form>
