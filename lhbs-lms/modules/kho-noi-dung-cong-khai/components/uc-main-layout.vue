  ...
  <Global>
    ...
    >
      ...
      <template #item.Preview="{ item }">
        <v-btn
          v-if="item.ResourceType === 'ASSIGNMENT'"
          color="primary"
          variant="outlined"
          size="small"
    ...
    <uc-confirm-get-resource
      v-model="isShowModalSelectWeek"
